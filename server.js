...
// ── App factory ───────────────────────────────────────────────────────────────
// Creates and returns a configured Express app without starting the HTTP server.
// Pass a better-sqlite3 Database instance; tests inject `:memory:` databases,
// production passes the file-backed database.
...
module.exports = { createApp, initDb, buildICS, isValidDate };

// ── Production entry point ────────────────────────────────────────────────────
// Only start the HTTP server when this file is executed directly (not required
// by tests).
